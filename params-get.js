...
app.get('/', (request,response)=>{
    ...
    response.send('<a href="/product-detail/24680">Product-Detail</a><hr/></hr.><a href="/search/node.js&express.js/5">Search</a><hr/><a href="/map/10.1122,50.5678/satellite/zoom=16">View Map</a>');
});
